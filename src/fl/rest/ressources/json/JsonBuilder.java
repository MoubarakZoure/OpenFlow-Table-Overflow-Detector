...
public class JsonBuilder {
    ...
    public JsonBuilder(RestUrlBuilder url_builder) {
    ...
    public Map<String, FlowsAggregate> getAllSwitchFlowsAggregateMap(String switchesIDList) {

        String url = url_builder.build_opf_stats_switch_url(switchesIDList, OFStatsTypeStrings.AGGREGATE);
        String json = getJsonAt(url);
        

        Type type = new TypeToken<Map<String, FlowsAggregate>>() {
        }.getType();
        Map<String, FlowsAggregate> resultat = gson.fromJson(json, type);

        return resultat;

    }

    public Map<String, SwitchFlowsStats> getSwitchFlowsStatsMap(String switchIDList) {
        String url = url_builder.build_opf_stats_switch_url(switchIDList, OFStatsTypeStrings.FLOW);
        String json = getJsonAt(url);
    ...
    public Map<String, SwitchTablesStats> getAllSwitchTablesStatsMap(String switchesIDList) {

        String url = url_builder.build_opf_stats_switch_url(switchesIDList, OFStatsTypeStrings.TABLE);
        String json = getJsonAt(url);

        Type type = new TypeToken<Map<String, SwitchTablesStats>>() {
        }.getType();
        Map<String, SwitchTablesStats> resultat = gson.fromJson(json, type);
    ...
    public Map<String, SwitchTablesStats> getAllSwitchTablesStats() {
    ...
    public Map<String, FlowsAggregate> getAllSwitchFlowsAggregate() {
    ...
    public static void main(String[] args) {
        ...
        JsonBuilder jsonBuilder = new JsonBuilder(restUrlBuilder);
