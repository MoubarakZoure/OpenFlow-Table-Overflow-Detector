...
public class Predict {
    ...
    public static void main(String argv[]) {
        ...
        try {
            BufferedReader input = new BufferedReader(new FileReader("src/heart_scale.scale"));
            DataOutputStream output = new DataOutputStream(new BufferedOutputStream(new FileOutputStream("src/heart_scale_result")));
            svm_model model = svm.svm_load_model("src/svm_model");

            if (model == null) {
                System.err.print("can't open model file n");
                System.exit(1);
            }
            if (predict_probability == 1) {
